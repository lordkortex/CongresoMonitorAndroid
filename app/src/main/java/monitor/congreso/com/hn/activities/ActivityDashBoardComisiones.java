 ...
 */
public class ActivityDashBoardComisiones extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setTitle("Comisiones");
        activity = this;
        ...
        generic_field_1.setText( bundle.getString(MonitorConstants.FIELD_COMISION_NOMBRE));
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position,long id) {
                ...
                Class ourclass = null;
                Bundle bundle = getIntent().getExtras();
                String comision_nombre = bundle.getString(MonitorConstants.FIELD_COMISION_NOMBRE);
                StringBuilder txtXpath = new StringBuilder();
                String txtPathQuery = "";
                String txtPathFinal = "";
                txtXpath.append(" comision_dictaminadora_nombre  = '" + comision_nombre + "'");
                ...
                switch (position) {
                    ...
                    case 1:
                        txtPathFinal = "/NewDataSet/" + MonitorConstants.TABLE_XML_PROPONENTES_POR_COMISION + txtPathQuery;
                ...
                Intent ourintent = new Intent(ActivityDashBoardComisiones.this, ourclass);
