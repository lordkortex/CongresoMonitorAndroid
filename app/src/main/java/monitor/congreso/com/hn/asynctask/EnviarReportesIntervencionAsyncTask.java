...
/**
 * Created by CortesMoncada on 08/03/2015.
 */
public class EnviarReportesIntervencionAsyncTask extends AsyncTask<String, Void, String> {
    private Context context;

    private static String SOAP_ACTION1 = "http://tempuri.org/enviar_email_intervenciones";
    private static String NAMESPACE = "http://tempuri.org/";
    private static String METHOD_NAME1 = "enviar_email_intervenciones";
    ...
    public EnviarReportesIntervencionAsyncTask(Context context) {
