 ...
 */
public class ActivityIntervencionesRefresh extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (GetPrefs.contains(MonitorConstants.TABLE_XML_INTERVENCIONES) ) {
            xmlProyectos = GetPrefs.getString(MonitorConstants.TABLE_XML_INTERVENCIONES, "");
            xpath = GetPrefs.getString(MonitorConstants.TABLE_XML_INTERVENCIONS_XPATH, "");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id== android.R.id.home){
            try {
                Class ourclass = Class.forName("monitor.congreso.com.hn.activities.MainActivityMonitor");
                Intent ourintent = new Intent(ActivityIntervencionesRefresh.this, ourclass);
